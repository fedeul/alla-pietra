const Cart = () => {
  return (
    <>
      {/* <h1 className="text-red-600">Hola soy Cart</h1> */}
                ...
                <tr>
                  ...
                  <td className="text-center">
                    <div className="flex place-items-center">
                      <form className="mr-12" action="" method="POST">
            ...
            <div className="my-4 mt-6 -mx-2 lg:flex">
              ...
              <div className="lg:px-2 lg:w-1/2">
                ...
                <div className="p-4">
                  ...
                  <a href="#">
                    <button className="flex justify-center w-full uppercase  item-center  focus:shadow-outline focus:outline-none bg-yellow-400 shadow-md  place-items-center opacity-75 hover:opacity-100 text-yellow-900 hover:text-gray-900 rounded-full px-10 py-2 font-semibold">
                      <svg
                        aria-hidden="true"
                        data-prefix="far"
