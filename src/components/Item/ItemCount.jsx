    ...
    <>
      <div className=" my-4 bottom-auto">
        <div className="flex place-content-evenly">
          ...
          <button className="bg-yellow-400 shadow-md  flex place-items-center opacity-75 hover:opacity-100 text-yellow-900 hover:text-gray-900 rounded-full px-10 py-2 font-semibold">
            <svg
